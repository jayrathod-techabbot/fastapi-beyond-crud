...
@book_router.get("/{book_id}",response_model=Book,dependencies=[Depends(access_token_bearer)])
...
@book_router.patch("/{book_id}",status_code=status.HTTP_201_CREATED,response_model=Book,dependencies=[Depends(access_token_bearer)])
...
@book_router.delete("/{book_id}",dependencies=[Depends(access_token_bearer)])
